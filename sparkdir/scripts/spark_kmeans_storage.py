...
spark = (SparkSession.builder
    .appName("Azure_Functions_KMeans_Storage")
...
path = "s3a://azure-functions-raw/azure-cleaned-storage-invocation.json"
...
model.write().overwrite().save("s3a://azure-functions-raw/models/storage/azure_load_model")
...
centers_df.coalesce(1).write.mode("overwrite") \
    .csv("s3a://azure-functions-raw/results/storage/centroids.csv", header=True)
