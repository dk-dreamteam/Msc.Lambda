...
spark = (SparkSession.builder
    .appName("Azure_Functions_KMeans_HTTP")
...
path = "s3a://azure-functions-raw/azure-cleaned-http-invocation.json"
...
model.write().overwrite().save("s3a://azure-functions-raw/models/http/azure_load_model")
...
centers_df.coalesce(1).write.mode("overwrite") \
    .csv("s3a://azure-functions-raw/results/http/centroids.csv", header=True)
