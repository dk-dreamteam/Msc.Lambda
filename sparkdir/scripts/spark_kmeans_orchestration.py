...
spark = (SparkSession.builder
    .appName("Azure_Functions_KMeans_Orchestration")
...
path = "s3a://azure-functions-raw/azure-cleaned-orchestration-invocation.json"
...
model.write().overwrite().save("s3a://azure-functions-raw/models/orchestration/azure_load_model")
...
centers_df.coalesce(1).write.mode("overwrite") \
    .csv("s3a://azure-functions-raw/results/orchestration/centroids.csv", header=True)
