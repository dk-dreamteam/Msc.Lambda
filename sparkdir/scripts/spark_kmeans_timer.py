...
spark = (SparkSession.builder
    .appName("Azure_Functions_KMeans_Timer")
...
path = "s3a://azure-functions-raw/azure-cleaned-timer-invocation.json"
...
model.write().overwrite().save("s3a://azure-functions-raw/models/timer/azure_load_model")
...
centers_df.coalesce(1).write.mode("overwrite") \
    .csv("s3a://azure-functions-raw/results/timer/centroids.csv", header=True)
